...
const ContactUs = () => {
    ...
    formData.append("access_key", "c7eb51d0-7cf6-4631-8829-4f924f35231a");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4
    ...
    <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full' >
        ...
        <div className='sm:col-span-2'>
            ...
            <textarea  name="message" rows={8} placeholder='Enter your message' className='w-full p-3 text-sm
