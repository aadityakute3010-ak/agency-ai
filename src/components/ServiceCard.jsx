...
const ServiceCard = ({service,index}) => {
  ...
  return (
    <div className='relative overflow-hidden max-wl-lg m-2 sm:m-4 rounded-xl border 
    ...
    ref={divRef} onMouseMove={handleMouseMove}>
        ...
        transition-opacity duration-500 mix-blend-lighten ${visible ? 'opacity-70' : 'opacity-0'}`} style={{top: position.y - 150,
            left: position.x - 150}} />
            ...
            transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
                ...
                <div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
                    <img src={service.icon} key={index} alt="" className='max-w-24 bg-white
